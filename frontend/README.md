# AI Part Importer- Frontend Code

This directory contains the frontend code for the AI Part Importer plugin.
...
This will compile the frontend into the `../ai_part_importer/static` directory (ready for distribution).
